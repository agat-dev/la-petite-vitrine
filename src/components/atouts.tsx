    ...
    const timelineData = [
      {
        ...
        desc: "Un site vitrine clé en main",
        color: "from-coral-500 to-coral-500/70",
      },
      {
        year: "",
        title: "Seulement 390€ pour un site vitrine",
        desc: "Présentez votre activité en ligne",
        color: "from-blue-500 to-blue-500/70",
      },

      {
        year: "",
        title: "Maintenance offerte la première année",
        desc: "Puis 9€/mois avec engagement d'un an",
        color: "from-coral-500 to-coral-500/70",
      },
      {
        year: "",
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 8px 32px rgba(0, 0, 0, 0.15), 0 4px 16px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.4), inset 0 -1px 0 rgba(255, 255, 255, 0.2)",
              ...
              >
                ...
                {/* Subtle Accent */}
                <div
                  className={`mt-4 w-12 h-0.5 bg-gradient-to-r ${item.color} rounded-full`}
                ></div>
              </div>
            </div>
          ))}
  ...
  return (
    <section className="relative min-h-screen py-16 md:py-24 lg:py-36 px-8 sm:px-4 lg:px-28 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-35">
        ...
        <svg
          className="absolute top-1/5 right-1/6 w-2/5 h-2/5"
          viewBox="0 0 350 300"
          preserveAspectRatio="none"
        >
          <path
        ...
        {/* Courbes entrelacées */}
        <svg
          className="absolute bottom-1/5 left-1/8 w-1/3 h-1/3"
          viewBox="0 0 250 200"
          preserveAspectRatio="none"
        >
          <path
        ...
        {/* Motifs en étoile */}
        <svg
          className="absolute bottom-1/3 right-1/5 w-80 h-80"
          viewBox="0 0 180 180"
        >
          <path
