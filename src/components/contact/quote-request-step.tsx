    ...
    <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 lg:p-12 shadow-2xl">
      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Label htmlFor="projectType" className="text-white font-medium">Type de projet *</Label>
            <Select onValueChange={(value) => handleInputChange('projectType', value)} value={formData.projectType}>
              <SelectTrigger className="mt-1 bg-white/40 border-white/30 text-white backdrop-blur-sm">
                <SelectValue placeholder="Sélectionnez le type de projet" className="placeholder:text-white/40" />
              </SelectTrigger>
          ...
          <div>
            <Label htmlFor="budget" className="text-white font-medium">Budget estimé *</Label>
            <Select onValueChange={(value) => handleInputChange('budget', value)} value={formData.budget}>
              <SelectTrigger className="mt-1 bg-white/40 border-white/30 text-white backdrop-blur-sm">
                <SelectValue placeholder="Sélectionnez votre budget" className="placeholder:text-white/40" />
              </SelectTrigger>
              <SelectContent className="bg-white/95 backdrop-blur-sm border-white/30">
          ...
          <div>
            <Label htmlFor="timeline" className="text-white font-medium">Délai souhaité *</Label>
            <Select onValueChange={(value) => handleInputChange('timeline', value)} value={formData.timeline}>
              <SelectTrigger className="mt-1 bg-white/40 border-white/30 text-white backdrop-blur-sm">
                <SelectValue placeholder="Sélectionnez le délai" className="placeholder:text-white/40" />
              </SelectTrigger>
              <SelectContent className="bg-white/95 backdrop-blur-sm border-white/30">
          ...
          <div>
            <Label htmlFor="description" className="text-white font-medium">Description du projet *</Label>
            <Textarea
              id="description"
              ...
              rows={5}
              required
              className="mt-1 bg-white/40 border-white/30 text-white placeholder:text-white/40 backdrop-blur-sm resize-none"
            />
          </div>
          ...
          <div className="flex items-center space-x-3 p-4 bg-white/20 rounded-xl border border-white/30">
            ...
            />
            <Label htmlFor="urgentProject" className="text-white font-medium cursor-pointer">
              Projet urgent
            </Label>
          </div>

          <div>
            <Label htmlFor="additionalInfo" className="text-white font-medium">Informations complémentaires</Label>
            <Textarea
              id="additionalInfo"
          ...
          <div className="flex justify-between pt-6 border-t border-white/20">
            ...
            <Button
              ...
              className="bg-white/80 text-gray-900 hover:bg-white disabled:opacity-50 disabled:cursor-not-allowed backdrop-blur-sm font-medium"
            >
              Continuer
            </Button>
          </div>
